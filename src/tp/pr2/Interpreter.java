...
public class Interpreter {
	...
	private static String help="WALL·E > The valid instructions for WALL-E are:" + LINE_SEPARATOR +
	"     MOVE"+ LINE_SEPARATOR + "     " + "TURN <LEFT | RIGHT>" + LINE_SEPARATOR + "     PICK <id>" + LINE_SEPARATOR +
